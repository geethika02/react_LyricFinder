                    ...
                    return (
                         <div className="card card-body mb-4 p-4">
                             <h1 className="display-4 text-center">
                                <i className="fas fa-music"/> <b>Search for a Song </b>
                             </h1>
                             <p className="lead text-center"><b>GET THE LYRICS FOR ANY SONG HERE</b></p>
                             ...
                             <br/>
                             <button className="btn btn-dark btn-primary btn-lg btn-block mb-5" type="submit">Get Track Lyrics</button>
                         </div>
                    );
                }}
            </Consumer>
